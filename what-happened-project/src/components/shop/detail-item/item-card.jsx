...
function ItemCard() {
  return (
    <div className="col-span-4">
      ...
      <button className="w-full border-2 border-[#eff0f4] bg-[#f6f4f4] p-5 flex flex-row justify-between items-center">
      ...
      <div className="mb-8">
        ...
        <ul className="text-sm font-light">
          <li className="flex flex-row space-x-[66px]">
          ...
          <li className="space-x-[50px] flex flex-row">
      ...
      <div className="flex">
        <button className="w-1/2 border-2 border-[#0565bb] bg-[#f8f8f8] text-[#0565bb] text-base font-medium py-6">
          add cart
        </button>
        <button className="w-1/2 bg-[#0565bb] text-white text-base font-medium py-6">
          buy now
        </button>
      </div>
    </div>
